...
public class Firefox_Resolution_1920 {
	public static void main(String[] args) throws IOException, InterruptedException {
		WebDriver driver=new FirefoxDriver();
		driver.get("https://www.getcalley.com/page-sitemap.xml");
		TakesScreenshot t=(TakesScreenshot)driver;
		File src = t.getScreenshotAs(OutputType.FILE);
		File dest = new File("./Firefox/a1.png");
		...
		File dest1 = new File("./Firefox/a2.png");
		...
		File dest2 = new File("./Firefox/a3.png");
		...
		File dest3 = new File("./Firefox/a4.png");
		...
		File dest4 = new File("./Firefox/a5.png");
		...
		File dest5 = new File("./Firefox/a6.png");
