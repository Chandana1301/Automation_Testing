...
public class Firefox_Resolution_414 {
	public static void main(String[] args) throws IOException, InterruptedException {
		WebDriver driver=new FirefoxDriver();
		driver.get("https://www.getcalley.com/page-sitemap.xml");
		TakesScreenshot t=(TakesScreenshot)driver;
		File src = t.getScreenshotAs(OutputType.FILE);
		File dest = new File("./Firefox_414/a1.png");
		...
		File dest1 = new File("./Firefox_414/a2.png");
		...
		File dest2 = new File("./Firefox_414/a3.png");
		...
		File dest3 = new File("./Firefox_414/a4.png");
		...
		File dest4 = new File("./Firefox_414/a5.png");
		...
		File dest5 = new File("./Firefox_414/a6.png");
